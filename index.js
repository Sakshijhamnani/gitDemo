...
function handleSubmit(event){
    ...
    axios.post('https://crudcrud.com/api/3a31fe74b3dd458b845887a29f3a2262/Products',obj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    axios.get('https://crudcrud.com/api/3a31fe74b3dd458b845887a29f3a2262/Products')
    .then((response)=>{
...
function DeleteUser(id,price) {
    axios.delete(`https://crudcrud.com/api/3a31fe74b3dd458b845887a29f3a2262/Products/${id}`)
        .then((res) => {
